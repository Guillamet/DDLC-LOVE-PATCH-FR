...
[[
Erreur !
Une vieille sauvegarde a été détectée et n'est pas compatible avec cette version.

S'il vous plaît supprimez toutes les données de sauvegardes et réessayez.

Supprimez tout dans ce répertoire :
